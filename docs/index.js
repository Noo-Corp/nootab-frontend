...
function setUrl() {
    ...
    if (input.value != "") {
      ...
      editor.focus();
      if (sText != "") {
        editor.innerHTML += '<a class="editor-link" href="' + input.value + '" onclick="event.preventDefault(); window.open(\'' + input.value + '\', \'_blank\');">' + sText + '</a>';
      } else {
        editor.innerHTML += '<a class="editor-link" href="' + input.value + '" onclick="event.preventDefault(); window.open(\'' + input.value + '\', \'_blank\');">' + input.value + '</a>';
      }
      input.value = "";
    }
  }